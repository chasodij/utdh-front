...
const FilterList = ({ filter, setFilter }) => {
  ...
  return (
    <div>
        ...
        <Accordion alwaysOpen>
              ...
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <input
                    ...
                    name="system_wom"
                  ></input>
                  <label htmlFor="system_wom">Бездзеркальна</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="system_wm"
                  ></input>
                  <label htmlFor="system_wm">Дзеркальна</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="system_c" name="system_c"></input>
                  <label htmlFor="system_c">Компактна</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="system_qp"
                  ></input>
                  <label htmlFor="system_qp">Миттєвого друку</label>
                </li>
              </ul>
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="1">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="video_4k" name="video_4k"></input>
                  <label htmlFor="video_4k">4K(4096x2160)</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="video_8k" name="video_8k"></input>
                  <label htmlFor="video_8k">8K(7680x4320)</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="video_6k" name="video_6k"></input>
                  <label htmlFor="video_6k">6K(6000x3164)</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="video_fh43"
                  ></input>
                  <label htmlFor="video_fh43">FullHD(1440x1080)</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="video_fh169"
                  ></input>
                  <label htmlFor="video_fh169">FullHD(1920x1080)</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="video_hd" name="video_hd"></input>
                  <label htmlFor="video_hd">HD(1280x720)</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="video_uhd"
                  ></input>
                  <label htmlFor="video_uhd">UHD 4K(3840x2160)</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="video_vga"
                  ></input>
                  <label htmlFor="video_vga">VGA(640x480)</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="video_wo" name="video_wo"></input>
                  <label htmlFor="video_wo">Без запису відео</label>
                </li>
              </ul>
            </Accordion.Body>
          </Accordion.Item>
              ...
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <input
                    ...
                    name="sensorSize_1"
                  ></input>
                  <label htmlFor="sensorSize_1">1''</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="sensorSize_1_2"
                  ></input>
                  <label htmlFor="sensorSize_1_2">1/2.3'' та менше</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="sensorSize_131"
                  ></input>
                  <label htmlFor="sensorSize_131">13.1x8.8 мм</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="sensorSize_132"
                  ></input>
                  <label htmlFor="sensorSize_132">13.2x8.8 мм</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="sensorSize_18"
                  ></input>
                  <label htmlFor="sensorSize_18">18.7x14 мм</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="sensorSize_43"
                  ></input>
                  <label htmlFor="sensorSize_43">4/3''(17.3x13 мм)</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="sensorSize_asp"
                  ></input>
                  <label htmlFor="sensorSize_asp">ASP_C</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="sensorSize_FF"
                  ></input>
                  <label htmlFor="sensorSize_FF">Full Frame (35 мм)</label>
                </li>
              </ul>
            </Accordion.Body>
          </Accordion.Item>
              ...
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <input
                    ...
                    name="optica_yes"
                  ></input>
                  <label htmlFor="optica_yes">з об'єктивом(Kit)</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="optica_no"
                  ></input>
                  <label htmlFor="optica_no">без об'єктива(Body)</label>
                </li>
              </ul>
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="4">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="Zoom_wo" name="Zoom_wo"></input>
                  <label htmlFor="Zoom_wo">Без маштабування</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="Zoom_36" name="Zoom_36"></input>
                  <label htmlFor="Zoom_36">Оптичний зум 20х_36х</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="Zoom_20" name="Zoom_20"></input>
                  <label htmlFor="Zoom_20">Оптичний зум 6х_20х</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="Zoom_6" name="Zoom_6"></input>
                  <label htmlFor="Zoom_6">Оптичний зум до 6х</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="Zoom_36Up"
                  ></input>
                  <label htmlFor="Zoom_36Up">Оптичний зум понад 36х</label>
                </li>
              </ul>
            </Accordion.Body>
          </Accordion.Item>
              ...
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <input
                    ...
                    name="interface_mj"
                  ></input>
                  <label htmlFor="interface_mj">3.5 mini_jack</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="interface_av"
                  ></input>
                  <label htmlFor="interface_av">AV</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="interface_bt"
                  ></input>
                  <label htmlFor="interface_bt">Bluetooth</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="interface_gps"
                  ></input>
                  <label htmlFor="interface_gps">GPS</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="interface_hdmi"
                  ></input>
                  <label htmlFor="interface_hdmi">HDMI</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="interface_mc_usb"
                    name="interface_mc_usb"
                  ></input>
                  <label htmlFor="interface_mc_usb">Micro USB</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="interface_usb30"
                    name="interface_usb30"
                  ></input>
                  <label htmlFor="interface_usb30">USB 3.0</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="interface_usb31"
                    name="interface_usb31"
                  ></input>
                  <label htmlFor="interface_usb31">USB 3.1</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="interface_usb31c"
                    name="interface_usb31c"
                  ></input>
                  <label htmlFor="interface_usb31c">USB 3.1 Type_C</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="interface_usb32"
                    name="interface_usb32"
                  ></input>
                  <label htmlFor="interface_usb32">USB 3.2</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="interface_usbc"
                  ></input>
                  <label htmlFor="interface_usbc">USB Type_C</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="interface_wf"
                  ></input>
                  <label htmlFor="interface_wf">Wi_Fi</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="interface_mc_hdmi"
                    name="interface_mc_hdmi"
                  ></input>
                  <label htmlFor="interface_mc_hdmi">micro_HDMI</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="interface_mi_usb"
                    name="interface_mi_usb"
                  ></input>
                  <label htmlFor="interface_mi_usb">mini_USB</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="interface_mi_hdmi"
                    name="interface_mi_hdmi"
                  ></input>
                  <label htmlFor="interface_mi_hdmi">mini_HDMI</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="interface_nfc"
                  ></input>
                  <label htmlFor="interface_nfc">NFC</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    ...
                    name="interface_usb"
                  ></input>
                  <label htmlFor="interface_usb">USB</label>
                </li>
              </ul>
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="6">
            <Accordion.Header>
              <p className="MainPage_Filter_item_name">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="px_16" name="px_16"></input>
                  <label htmlFor="px_16">12 _ 16 Мп</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="px_20" name="px_20"></input>
                  <label htmlFor="px_20">16 _ 20 Мп</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="px_12" name="px_12"></input>
                  <label htmlFor="px_12">До 12 Мп</label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input type="checkbox" id="px_20Up" name="px_20Up"></input>
                  <label htmlFor="px_20Up">Понад 20 Мп</label>
                </li>
              </ul>
            </Accordion.Body>
          </Accordion.Item>
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="display_fastening_down"
                    name="display_fastening_down"
                  ></input>
                  <label htmlFor="display_fastening_down">
                    Екран, шарнір знизу
                  </label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="display_fastening_spin"
                    name="display_fastening_spin"
                  ></input>
                  <label htmlFor="display_fastening_spin">
                    Поворотний дисплей
                  </label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <input
                    type="checkbox"
                    id="display_fastening_nospin"
                    name="display_fastening_nospin"
                  ></input>
                  <label htmlFor="display_fastening_nospin">
                    Фіксований дисплей
                  </label>
                </li>
              </ul>
          ...
          <Accordion.Item eventKey="8">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                ...
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="micro_ability">
                    <input
                      type="checkbox"
                      id="micro_ability"
                      name="micro_ability"
                    ></input>
                    Роз'єм для зовнішнього мікрофона
                  </label>
                </li>
              </ul>
            </Accordion.Body>
          ...
          <Accordion.Item eventKey="9">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="protect_underwater">
                    <input
                      type="checkbox"
                      id="protect_underwater"
                      name="protect_underwater"
                    ></input>
                    Для підводної зйомки
                  </label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="protect_dust">
                    <input
                      type="checkbox"
                      id="protect_dust"
                      name="protect_dust"
                ...
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="protect_metal">
                    <input
                      type="checkbox"
                      id="protect_metal"
                      name="protect_metal"
                    ></input>
                    Тонкий металевий корпус
                  </label>
                </li>
              </ul>
            </Accordion.Body>
          ...
          <Accordion.Item eventKey="10">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                ...
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="power_aa">
                    <input
                      type="checkbox"
                      id="power_aa"
                      name="power_aa"
                    ></input>
                    Робота від батарей АА
                  </label>
                </li>
              </ul>
            </Accordion.Body>
          ...
          <Accordion.Item eventKey="12">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                ...
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="stable_el">
                    <input
                      type="checkbox"
                      id="stable_el"
                      name="stable_el"
                    ></input>
                    Електронна стабілізація
                  </label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="stable_mx">
                    <input
                      type="checkbox"
                      id="stable_mx"
                      name="stable_mx"
                    ></input>
                    Стабілізація зрушенням матриці
                  </label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="stable_op">
                    <input
                      type="checkbox"
                      id="stable_op"
                      name="stable_op"
          ...
          <Accordion.Item eventKey="13">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="raw_no">
                    <input type="checkbox" id="raw_no" name="raw_no"></input>
                    Знімання тільки в JPEG
                  </label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="raw_yes">
                    <input type="checkbox" id="raw_yes" name="raw_yes"></input>
                    Знімання в RAW і JPEG
                  </label>
                </li>
              </ul>
            </Accordion.Body>
          ...
          <Accordion.Item eventKey="15">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="sensordisplay_no">
                    <input
                      type="checkbox"
                      id="sensordisplay_no"
                      name="sensordisplay_no"
                    ></input>
                    Без сенсорного керування
                  </label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="sensordisplay_yes">
                    <input
                      type="checkbox"
                      id="sensordisplay_yes"
                      name="sensordisplay_yes"
                    ></input>
                    Із сенсорним управлінням
                  </label>
                </li>
              </ul>
            </Accordion.Body>
          ...
          <Accordion.Item eventKey="16">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="expo_man">
                    <input
                      type="checkbox"
                      id="expo_man"
                      name="expo_man"
                    ></input>
                    Є ручні режими (P, A, S, M)
                  </label>
                </li>
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="expo_auto">
                    <input
                      type="checkbox"
                      id="expo_auto"
                      name="expo_auto"
                    ></input>
                    Автоматичні та сценічні режими{" "}
                  </label>
                </li>
              </ul>
            </Accordion.Body>
          ...
          <Accordion.Item eventKey="17">
            ...
            <Accordion.Body>
              <ul className="MainPage_Filter_list_in">
                ...
                <li className="MainPage_Filter_item_in">
                  <label htmlFor="displaysize_3Up">
                    <input
                      type="checkbox"
                      id="displaysize_3Up"
                      name="displaysize_3Up"
                    ></input>
                    Понад 3"
                  </label>
                </li>
      ...
      <button className="MainPage_Filter_Button" onClick={filter}>
        ФІЛЬТРУВАТИ
      </button>
    </div>
  );
